...
public:
	...
	uint8_t setDivlEnReg(uint8_t IRQPushPull, uint8_t MfinActIEn, uint8_t CRCIEn);
	uint8_t setComIrqReg(uint8_t ComIrqReg, uint8_t TxIRq, uint8_t RxIRq, uint8_t IdleIRq, uint8_t HiAlertIRq, uint8_t LoAlertIRq, uint8_t ErrIRq, uint8_t TimerIRq);
	uint8_t setDivIrqReg(uint8_t Set2, uint8_t MfinActIRq, uint8_t CRCIRq);
	...
	uint8_t CollReg ();
	void setModeReg (uint8_t);
	uint8_t ModeReg ();
	void setTxModeReg (uint8_t);
	uint8_t TxModeReg ();
	void setRxModeReg (uint8_t);
	uint8_t RxModeReg ();
	uint8_t TxControlReg ();
	void setTxASKReg (uint8_t);
	uint8_t TxASKReg ();
	uint8_t TxSelReg ();
	uint8_t RxSelReg ();
	...
	void setModWidthReg (uint8_t);
	uint8_t ModWidthReg ();
	uint8_t RFCfgReg ();
	uint8_t GsNReg ();
	uint8_t CWGsPReg ();
	uint8_t ModGsPReg ();
	void setTModeReg (uint8_t);
	uint8_t TModeReg ();
	void setTPrescalerReg (uint8_t);
	uint8_t TPrescalerReg ();
	void setTReloadReg (uint16_t);
	uint16_t TReloadReg ();
